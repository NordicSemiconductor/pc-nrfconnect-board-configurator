...
In the Board Configurator app, you can update the configuration of the board controller on a [supported Nordic Semiconductor Development Kit](index.md#supported-devices).
...
1. Click [**Select device**](https://docs.nordicsemi.com/bundle/nrf-connect-desktop/page/common_interface.html#select-device) and select the device from the drop-down list.</br>
