...
| November 2024  | Added information about the need to enable **External memory** option for nRF54H20 on the [Updating the board configuration](updating.md) and [Troubleshooting](troubleshooting.md#unable-to-perform-dfu-with-external-flash-on-nrf54h20) pages.  |
